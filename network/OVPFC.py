...
class OVPFC(BaseModule):
    ...
    def __init__(self, cfgs, nclasses,pos_dim=3,use_pa_seg=True,use_sem_loss=True,
        ...
        self.use_pa_seg_loss = cfgs['model']['use_pa_seg_loss']
        self.use_dice_loss = cfgs['model']['use_dice_loss']
        self.cal_sem_loss = cfgs['model']['cal_sem_loss']
        self.geometric_ensemble = cfgs['model']['geometric_ensemble']
        self.use_lable_weight = cfgs['model']['use_lable_weight']
    ...
    def loss_single_layer(self, class_preds, mask_preds, pos_mask_preds, class_targets, mask_targets, label_weights, layer, train_dict,text_features,sem_preds,reduction_override=None):
        ...
        if class_preds is not None:
            ...
            losses[f'loss_cls_{layer}'] = self.loss_cls(
                class_preds, # [133, 13]
                class_targets, # [133]
                label_weights if self.use_lable_weight else None, # [133,13]
